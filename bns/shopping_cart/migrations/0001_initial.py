# Generated by Django 3.0.5 on 2020-05-29 23:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
                ('amount', models.PositiveIntegerField(default=0)),
                ('buyer', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ManyToManyField(blank=True, to='listings.Post')),
            ],
        ),
    ]
